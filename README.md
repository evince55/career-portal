...
├── PWA service worker (career-portal-v14): network-first pages, cache-first assets
...
| `service-worker.js` | PWA cache `career-portal-v14` |
...
- **Service worker cache name** is `career-portal-v14` — bump it and `ASSETS_TO_CACHE`
