...
├── PWA service worker (career-portal-v17): network-first pages, cache-first assets
...
| `service-worker.js` | PWA cache `career-portal-v17` |
...
- **Service worker cache name** is `career-portal-v17` — bump it and `ASSETS_TO_CACHE`
