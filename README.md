...
├── PWA service worker (career-portal-v16): network-first pages, cache-first assets
...
| `service-worker.js` | PWA cache `career-portal-v16` |
...
- **Service worker cache name** is `career-portal-v16` — bump it and `ASSETS_TO_CACHE`
