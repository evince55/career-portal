...
├── PWA service worker (career-portal-v15): network-first pages, cache-first assets
...
| `service-worker.js` | PWA cache `career-portal-v15` |
...
- **Service worker cache name** is `career-portal-v15` — bump it and `ASSETS_TO_CACHE`
